...
namespace ServiceFabric.Mocks
{
    public static class MockActorServiceFactory
    {
        ...
        /// <param name="settings">Optional settings. By default, null is used.</param>
        /// <returns></returns>
        public static TActorService CreateCustomActorServiceForActor<TActorService, TActor>(Func<ActorService, ActorId, ActorBase> actorFactory = null, IActorStateProvider actorStateProvider = null, StatefulServiceContext context = null, ActorServiceSettings settings = null, Func<ActorBase, IActorStateProvider, IActorStateManager> stateManagerFactory = null)
            where TActor : Actor
