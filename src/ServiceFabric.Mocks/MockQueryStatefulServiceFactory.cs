...
namespace ServiceFabric.Mocks
{
    ...
    public static class MockQueryServiceFactory
    {
        ...
        {
            System.Fabric.Query.ServiceMetadata serviceMetadata = default;
            object[] param =
            {
                serviceName, serviceTypeName, serviceManifestVersion, healthState, serviceStatus,serviceMetadata, isServiceGroup
            };
